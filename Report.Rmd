...
\center{Figure 1: The above graph shows the distribution of values of the six pollutant parameters.}
...
for (i in unique(df$siteName)) {
  ...
  # axis(1, at = as.Date("2018-10-15"), labels = "Oct")
  # axis(1, at = as.Date("2019-10-15"), labels = "Oct")
  # axis(1, at = as.Date("2020-10-15"), labels = "Oct")

  # axis(1, at = as.Date("2019-02-15"), labels = "Feb")
  # axis(1, at = as.Date("2020-02-15"), labels = "Feb")
}
```

\center{Figure 4: The above graph shows the time series plot of PM2.5 parameter for all 10 stations in the data.}
...
\flushleft{Figure 5: The above graph shows the time series plot of PM2.5 parameter for all 10 stations in the data highlighted in red with the interval where there is a jump in PM2.5 values.}

...
\center Figure 3: The above graph shows the time series plot of PM2.5 parameter for all 10 stations in the data.
...
for (i in unique(df$siteName)) {
  ...
  colour <- ifelse((df[df$siteName==i,]$PM2.5<400),"black", "red")
  
  plot(x0, y0, type="n", main = i, xlab = "", ylab = "", ylim = c(0,700), lwd.ticks=2)
  
  segments(x0 = x0, y0 = y0, x1 = x1, y1 = y1, col = colour)
...
# col=ifelse(((x<as.Date("2019-10-15") & x>as.Date("2020-02-15"))),"red", "blue")
```
